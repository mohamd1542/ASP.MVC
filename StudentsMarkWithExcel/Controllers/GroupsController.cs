...
namespace StudentsMarkWithExcel.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public GroupsController(StudentsMarkLiveContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Group != null ?
                        ...
                        Problem("Entity set 'StudentsMarkLiveContext.Group'  is null.");
        }

        public ActionResult Search(string searchTerm)
        {
            var groups = _context.Group.Where(p => p.Name.Contains(searchTerm));
            return View(groups);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            List<GroupStudent> groupStudent = _context.GroupStudent.Where(p => p.GroupId == id).Include(p => p.Student).ToList();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentsMarkLiveContext.Group'  is null.");
            }
            var @group = await _context.Group.FindAsync(id);
            if (@group != null)
            {
