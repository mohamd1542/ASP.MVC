...
namespace StudentsMarkWithExcel.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(StudentsMarkLiveContext context)
        {
            _context = context;
        }
        ...
        {
            var course = _context.Courses.Where(p => p.CourseName.Contains(searchTerm));
            return View(course);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //مصفوفة العلامات المتعلقة بالكورس 
            List<Degree> degrees = _context.Degrees.Where(p => p.CourseId == id).Include(p=>p.Student).ToList();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentsMarkLiveContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
